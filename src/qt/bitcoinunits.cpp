...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BS");
    case mBTC: return QString("mBS");
    case uBTC: return QString::fromUtf8("μBS");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("BlackShadowCoins"));
    case mBTC: return QString(QObject::tr("Milli-BlackShadowCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-BlackShadowCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
