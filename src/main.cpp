...
const string strMessageMagic = "BlackShadowCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("BlackShadowCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BlackShadowCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // BlackShadowCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BlackShadowCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BlackShadow Genesis";
        CTransaction txNew;
        txNew.nTime = 1470105014;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 1587697; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0x94, 0xe8, 0xc3, 0xe5 };
