BlackShadowCoin-qt: Qt4 GUI for BlackShadowCoin
===============================
...
Alternatively, install Qt Creator and open the `BlackShadowCoin-qt.pro` file.

An executable named `BlackShadowCoin-qt` will be built.
...
A warning for people using the *static binary* version of BlackShadowCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of BlackShadowCoin is linked against libdb5.3.
...
installed causes BlackShadowCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
