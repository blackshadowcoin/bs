...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("BlackShadowCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("BlackShadowCoin-net");
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("BlackShadowCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("BlackShadowCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("BlackShadowCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("BlackShadowCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BlackShadowCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("BlackShadowCoin-start");
